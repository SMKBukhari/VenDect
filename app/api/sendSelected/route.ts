import { compieSendSelectedEmailTemplate, sendMail } from "@/lib/mail";
...
export const POST = async (req: Request) => {
    try {
        ...
        const emailBody = await compieSendSelectedEmailTemplate(fullName, title);
        ...
        const response = await sendMail({
            ...
            name: fullName,
            jobTitle: title,
            subject: "Congratulations! You have been selected for the interview",
            body: emailBody,
        });
