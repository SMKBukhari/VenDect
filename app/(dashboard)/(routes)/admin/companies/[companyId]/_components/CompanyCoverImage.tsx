...
const CompanyCoverImage = ({ initialData, companyId }: CompanyCoverImageProps) => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      toast.success("Company Cover Image updated successfully.");
      toggleEiditing();
      router.refresh();
    } catch (error) {
      toast.error("Failed to update Company Cover Image!");
    }
  };
